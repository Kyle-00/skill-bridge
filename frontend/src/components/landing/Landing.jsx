  ...
  return (
    <div className="bg-linear-to-br from-white via-gold-50/30 to-white dark:from-gray-900 dark:via-gold-950/20 dark:to-gray-900 min-h-screen overflow-hidden">
      ...
      >
        ...
        <motion.h1 variants={fadeInUp} className="text-5xl md:text-7xl font-bold leading-tight text-gold-800 dark:text-gold-300">
          Bridge Your Talent to <br />
          <span className="text-gold-600 dark:text-gold-400">Global Opportunities</span>
        </motion.h1>
        <motion.p variants={fadeInUp} className="mt-6 text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
        ...
        <motion.div variants={fadeInUp} className="mt-10 flex flex-wrap gap-4 justify-center">
          <Link to="/register" className="px-8 py-3 bg-gold-600 text-white rounded-full hover:bg-gold-700 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            Get Started - It's Free
          </Link>
          <Link to="/find-work" className="px-8 py-3 border-2 border-gold-600 text-gold-600 rounded-full hover:bg-gold-50 dark:hover:bg-gold-900/30 transition-all duration-300 transform hover:-translate-y-1">
      ...
      {/* SkillBridge vs The Rest */}
      <section className="max-w-7xl mx-auto px-4 py-20">
        <h2 className="text-3xl md:text-4xl font-bold text-center text-gold-700 dark:text-gold-300 mb-16">
          Why We're Different
        </h2>
        <div className="grid md:grid-cols-2 gap-8">
          <div className="glass p-6 rounded-2xl shadow-lg flex items-start gap-4">
            <div className="text-3xl text-gold-500 shrink-0"><FaDollarSign /></div>
            <div>
              <h3 className="text-xl font-semibold text-gold-800 dark:text-gold-200">0% Client Fee</h3>
              <p className="text-gray-600 dark:text-gray-400">Unlike Fiverr and Upwork, we charge clients nothing - zero platform fees.</p>
            </div>
          </div>
          <div className="glass p-6 rounded-2xl shadow-lg flex items-start gap-4">
            <div className="text-3xl text-gold-500 shrink-0"><FaChartLine /></div>
            <div>
              <h3 className="text-xl font-semibold text-gold-800 dark:text-gold-200">AI-Powered Matching</h3>
              <p className="text-gray-600 dark:text-gray-400">Our bias-aware algorithms reduce spam and connect you with truly relevant work.</p>
            </div>
          </div>
          <div className="glass p-6 rounded-2xl shadow-lg flex items-start gap-4">
            <div className="text-3xl text-gold-500 shrink-0"><FaUserTie /></div>
            <div>
              <h3 className="text-xl font-semibold text-gold-800 dark:text-gold-200">M-Pesa & Crypto</h3>
              <p className="text-gray-600 dark:text-gray-400">We serve emerging markets with mobile money, plus Stripe and cryptocurrency.</p>
            </div>
          </div>
          <div className="glass p-6 rounded-2xl shadow-lg flex items-start gap-4">
            <div className="text-3xl text-gold-500 shrink-0"><FaClipboardList /></div>
            <div>
              <h3 className="text-xl font-semibold text-gold-800 dark:text-gold-200">Multi-Dimensional Reviews</h3>
              <p className="text-gray-600 dark:text-gray-400">Quality, communication, timeliness, professionalism - a fairer rating system.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      >
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            { name: 'Angel K.', role: 'Freelance Designer', quote: 'SkillBridge helped me find high-paying clients. The M-Pesa integration is a game-changer!' },
            { name: 'Kyle K.', role: 'Startup Founder', quote: 'I found top-tier developers quickly. The escrow system gave me peace of mind.' },
            { name: 'Jay B.', role: 'Software Engineer', quote: 'The AI matching saved me hours of searching. I love the low fees!' },
          ].map((testimonial, i) => (
            <motion.div key={i} variants={fadeInUp} className="glass p-6 rounded-2xl shadow-lg hover:shadow-xl transition">
              <div className="flex text-gold-400 mb-3">
                {[...Array(5)].map((_, j) => <FaStar key={j} className="w-4 h-4 fill-current" />)}
              </div>
